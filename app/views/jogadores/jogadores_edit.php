...
<head>
    <meta charset="UTF-8">
    <title>Projeto Integrador • Editar Jogador</title>
            ...
            <main class="flex-fill content">
                ...
                <div class="card shadow-sm">
                    <div class="card-body p-4">
                        <form action="<?= URL_BASE ?>/jogadores/atualizar" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" class="form-control" id="dataNascimento" name="dataNascimento" value="<?= $jogador['data_nascimento'] ?? '' ?>">
                                    <?php if (isset($erros['dataNascimento'])): ?>
                                        <div class="text-danger small"><?= $erros['dataNascimento'] ?></div>
                                    <?php endif; ?>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="peDominante" name="peDominante" value="<?= $jogador['pe_dominante'] ?? '' ?>">
                                </div>
